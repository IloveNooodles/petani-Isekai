...
itemPrice(cucumberSeed, 75).
itemPrice(garlicSeed, 75).
itemPrice(pumpkinSeed, 50).
itemPrice(sunflowerSeed, 10).
itemPrice(tomatoSeed, 25).
itemPrice(wheatSeed, 25).
itemPrice(apple, 100).
itemPrice(cucumber, 175).
itemPrice(garlic, 175).
itemPrice(pumpkin, 100).
itemPrice(sunflower, 15).
itemPrice(wheat, 50).
